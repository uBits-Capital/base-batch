...
import { WithdrawContent } from "../Actions/Withdraw";
...
export default function Withdraw({
  ...
  useEffect(() => {
    setDisabled(!(!loadingWithdraw && !quote0Loading && !quote1Loading));
  }, [loadingWithdraw, quote0Loading, quote1Loading]);
    ...
    >
      ...
      {showTxModal && (
        <TransactionModal
          ...
          modalType={ModalActionType.WITHDRAW}
          close={(type) => {
            setShowTxModal(false);
          ...
          withdrawTotalAmount={totalAmount}
          withdrawFeesAmount={totalRewards}
